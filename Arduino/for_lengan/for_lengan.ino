...
//    //step 3
//  //SERVO ATAS
//        for (int i =398; i<=307 ; i--) {
//    pwm.setPWM(4, 0, i--);
//    delay(50);}
//
//  //SERVO BAWAH
//        for (int i =288; i>=143 ; i--) {
//    pwm.setPWM(15, 0, i--);
//    delay(50);} 
//
//    //step1 balik
//      //SERVO ATAS
//        for (int i =307; i<=398 ; i++) {
//    pwm.setPWM(4, 0, i++);
//    delay(50);}
//
//  //SERVO BAWAH 
//        for (int i =143; i<=288 ; i++) {
//    pwm.setPWM(15, 0, i++);
//    delay(50);} 
//
//    //step2 balik
//    //Step 1
////  SERVO ATAS
//      for (int i =398; i>=300 ; i--) {
//    pwm.setPWM(4, 0, i--);}
//    
//   //SERVO BAWAH
//        for (int i =288; i<=300 ; i++) {
//    pwm.setPWM(15, 0, i++);
//    delay(50); }}
//
...
// program for untuk 2 variabel
//  for (int x = 300, y = 160; x <=400 && y<=220; x++,y++){
//    pwm.setPWM(4, 0, x++);
//    pwm.setPWM(5, 0, y++);
//    delay(100);}
//
//    for (int x = 400, y = 220; x >=300 && y>=160; x--,y--){
//    pwm.setPWM(4, 0, x--);
//    pwm.setPWM(5, 0, y--);
//    delay(100);}
